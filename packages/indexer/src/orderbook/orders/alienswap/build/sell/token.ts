...
import { BaseBuilder } from "@reservoir0x/sdk/dist/alienswap/builders/base";

import { redb } from "@/common/db";
import { toBuffer } from "@/common/utils";
import { config } from "@/config/index";
import * as utils from "@/orderbook/orders/alienswap/build/utils";
...
export const build = async (options: BuildOrderOptions) => {
  ...
  const builder: BaseBuilder = new Sdk.Alienswap.Builders.SingleToken(config.chainId);
